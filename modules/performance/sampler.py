...
class AdaptiveScheduler:
    ...
    def __init__(self):
        self._link_intervals: Dict[Tuple[int, int, int, int], float] = {}
        self._link_last_sampled: Dict[Tuple[int, int, int, int], float] = {}
        self._link_utilization: Dict[Tuple[int, int, int, int], float] = {}
    ...
    def remove_link(self, link_id: Tuple[int, int, int, int]):
        """移除链路"""
